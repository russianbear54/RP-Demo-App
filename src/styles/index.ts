export const styles = {
  ...
  screen: {
   mobile:"@media (max-width: 375px)",mobileLarge:"@media (max-width: 428px)",
    iPadMini: "@media (max-width: 768px) and (orientation: portrait) ",
    smallScreen: "@media (max-width: 1024px)",
